...
- 📝 Built-in **Character Editor** to refine, edit, and re-export characters.  
...
#### 3. 📝 Character Editor
- Edit or refine characters manually.  
- Modify **description, scenario, greeting, and dialogue**.  
- Upload or replace a **character image**.  
- Extract persona data from images with the **📥 Read Character Data** button.  
- Re-export the finalized character with `⏬ EXPORT ⏬` and `Download PNG`.
